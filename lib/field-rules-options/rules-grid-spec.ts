...
export const RULES_GRID_DYNAMIC_FUNCTION: Partial<
  Record<RulesGridFieldId, string>
> = {
...
export function getRulesGridFieldDataType(
  fieldId: RulesGridFieldId,
): TrackerField["dataType"] {
  if (fieldId === "rule_value") return "string";
  return isRulesGridFieldMulti(fieldId)
    ? "dynamic_multiselect"
    : "dynamic_select";
}
