...
export function createMasterDataGridId(name: string, existingIds?: Set<string>): string {
...
export function createMasterDataSectionId(name: string, existingIds?: Set<string>): string {
 const base = toSnakeId(name)
