...
export async function updateDefinitionPrompt(reportId: string, userPrompt: string) {
...
export async function createReportRun(reportId: string, trigger: ReportRunTrigger) {
