...
export function normalizeMasterDataScope(
  value: unknown,
): MasterDataScope | null {
...
export function parseProjectModuleSettings(
  settings: unknown,
): ParsedProjectModuleSettings {
...
export function resolveMasterDataScopeFromTracker(
  tracker?: { masterDataScope?: unknown } | null,
): MasterDataScope {
