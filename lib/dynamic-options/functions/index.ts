...
import { ID as ALL_FIELD_PATHS_INCLUDING_SHARED_ID, allFieldPathsIncludingShared } from './all-field-paths-including-shared'
import { ID as ALL_GRIDS_ID, allGrids } from './all-grids'
...
export function registerBuiltInDynamicOptions(): void {
  ...
  registerDynamicOptionsFunction(ALL_FIELD_PATHS_INCLUDING_SHARED_ID, allFieldPathsIncludingShared)
  registerDynamicOptionsFunction(ALL_GRIDS_ID, allGrids)
