...
export interface DynamicOptionsContext {
   ...
   */
  foreignGridDataBySchemaId?: Record<
    string,
...
export interface DynamicFunctionGraphNodeSourceCurrentContext extends DynamicFunctionGraphNodeBase {
...
export interface DynamicFunctionGraphNodeSourceLayoutFields extends DynamicFunctionGraphNodeBase {
...
export interface DynamicFunctionGraphNodeTransformFilter extends DynamicFunctionGraphNodeBase {
...
export interface DynamicFunctionGraphNodeTransformMapFields extends DynamicFunctionGraphNodeBase {
  kind: "transform.map_fields";
  config: { mappings: Record<string, DynamicValueSelector> };
}

export interface DynamicFunctionGraphNodeTransformUnique extends DynamicFunctionGraphNodeBase {
  kind: "transform.unique";
  config: { by: string };
}

export interface DynamicFunctionGraphNodeTransformSort extends DynamicFunctionGraphNodeBase {
  kind: "transform.sort";
  config: {
    by: string;
    direction?: "asc" | "desc";
...
export interface DynamicFunctionGraphNodeTransformLimit extends DynamicFunctionGraphNodeBase {
  kind: "transform.limit";
  config: { count: number };
}

export interface DynamicFunctionGraphNodeTransformFlattenPath extends DynamicFunctionGraphNodeBase {
  kind: "transform.flatten_path";
  config: { path: string };
}

export interface DynamicFunctionGraphNodeAiExtractOptions extends DynamicFunctionGraphNodeBase {
...
export interface DynamicFunctionGraphNodeOutputOptions extends DynamicFunctionGraphNodeBase {
  kind: "output.options";
  config: {
...
export type DynamicPipelineSourceStep =
  ...
  | {
      kind: "source.layout_fields";
      config?: { includeHidden?: boolean; excludeSharedTab?: boolean };
    }
  | {
      kind: "source.http_get";
      config: {
