...
export const CREATABLE_TRACKER_FIELD_TYPES: TrackerFieldType[] = TRACKER_FIELD_TYPES.filter(
...
export const FIELD_TYPE_GROUPS: Record<string, TrackerFieldType[]> = {
 ...
 'Date & time': ['date'],
 Choice: ['status', 'options', 'multiselect', 'dynamic_select', 'dynamic_multiselect', 'person'],
 Other: ['boolean', 'files'],
}
