...
/** Base class for field inner inputs (string, number, date trigger, select, etc.) so div grid and form dialogs share the same look. Border/ring removed; wrapper provides border. */
...
export function resolveTableStyles(
  ...
  return {
    ...
    headerHeight: densityHeaderHeight[density] ?? densityHeaderHeight.default,
    borderStyle:
      borderStyleMap[o.borderStyle ?? "default"] ?? borderStyleMap.default,
    accentBorder:
      accentBorderMap[o.accentColor ?? "default"] ?? accentBorderMap.default,
    tableBg: accentBgMap[o.accentColor ?? "default"] ?? accentBgMap.default,
    headerBg: accentHeaderBgMap[o.headerStyle ?? "default"] ?? "",
...
export function resolveKanbanStyles(
  ...
  return {
    ...
    cardPadding: cardSizePaddingMap[cardSize] ?? cardSizePaddingMap.md,
    accentBorder:
      accentBorderMap[o.accentColor ?? "default"] ?? accentBorderMap.default,
    borderStyle:
      borderStyleMap[o.borderStyle ?? "default"] ?? borderStyleMap.default,
