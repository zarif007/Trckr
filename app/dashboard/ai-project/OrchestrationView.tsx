...
function formatPlanDraft(plan?: unknown): string {
  if (!plan || typeof plan !== "object")
    return "Designing your project and trackers...";
  const p = plan as {
    project?: { name?: string };
    modules?: { name: string }[];
...
export function OrchestrationView({
  ...
  const hasQuestionsToShow =
    answeredQuestions.length > 0 || currentQuestion != null;
        ...
        <div className="p-4 space-y-4 text-sm leading-relaxed">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2 items-end">
                    <Textarea
                      ...
                      placeholder={
                        currentQuestion.placeholder ?? "Your answer..."
                      }
          ...
          {isPlanLoading && (
            <div className="text-foreground/90 whitespace-pre-wrap font-mono text-xs">
              <StreamingText
                text={formatPlanDraft(streamedPlan)}
                showCursor={true}
              />
            </div>
          )}
          ...
          {/* Building */}
          {stage === "building" &&
            (setupItems.length > 0 || buildItems.length > 0) && (
              <div className="space-y-4">
                {setupItems.length > 0 && (
                  <div className="space-y-2">
                    <p className="text-foreground/80">
                      Setting up project and modules:
                    </p>
                    {setupItems.map((item) => (
                      <div
                        key={
