...
export const projectAreaTileIconShell =
  'w-14 h-14 rounded-md bg-muted/45 border border-border/40 shadow-sm flex items-center justify-center shrink-0 transition-all duration-200 group-hover:border-primary/35 group-hover:bg-primary/8 group-hover:shadow-md'
...
export const projectAreaTileMotionButtonClass =
  'group flex w-full flex-col items-center gap-3 rounded-md border border-border/40 bg-background/60 p-4 shadow-sm transition-[border-color,box-shadow,background-color] duration-150 hover:border-primary/35 hover:bg-primary/[0.06] hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 focus-visible:ring-offset-background'
...
export const projectAreaTileOverflowButtonClass =
  'absolute top-1 right-1 z-20 inline-flex h-6 w-6 items-center justify-center rounded-md text-muted-foreground opacity-0 transition-all hover:bg-muted/80 hover:text-foreground group-hover/card:opacity-100'
...
export const projectAreaBreadcrumbNavClass =
  'flex min-w-0 flex-wrap items-center gap-1.5 rounded-md border border-border/40 bg-muted/15 px-2 py-1 text-[11px] text-muted-foreground shadow-sm'
...
export const projectAreaErrorToastClass =
  'fixed bottom-10 right-6 z-50 flex items-center gap-2 rounded-md border border-destructive/20 bg-destructive/10 px-4 py-2.5 text-xs font-medium text-destructive shadow-lg'

export const projectAreaErrorDismissClass =
  'rounded-md p-0.5 hover:bg-destructive/20'

/** Simple config / shortcut tiles (project & module Configs pages). */
export const projectAreaConfigTileButtonClass = projectAreaTileMotionButtonClass
