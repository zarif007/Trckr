  ...
  return (
    <Rnd
      default={{
        ...
        y:
          typeof window !== "undefined"
            ? Math.max(0, (window.innerHeight - DEFAULT_HEIGHT) / 2)
            : 0,
        width: DEFAULT_WIDTH,
      ...
      style={{
        zIndex: 50,
        backgroundColor: cliTheme.bgTabBar,
        borderColor: cliTheme.border,
      }}
    >
      <div
        className={cn(
      ...
      >
        <div className="flex flex-1 min-w-0 items-center gap-px overflow-x-auto">
            ...
            return (
              <div
                ...
                style={{
                  ...(isActive
                    ? {
                        backgroundColor: cliTheme.bg,
                        color: cliTheme.text,
                        borderBottomColor: cliTheme.success,
                      }
              ...
              >
                <button
                  type="button"
                  className="min-w-0 truncate text-left text-xs font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30 rounded-sm"
                  style={{ color: "inherit" }}
                ...
                {canCloseTab && (
                  <button
                    type="button"
                    className="opacity-0 group-hover:opacity-100 p-0.5 rounded-sm hover:bg-white/10 transition-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
          ...
          <button
            type="button"
            className="shrink-0 p-2 rounded-sm transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30 hover:bg-white/10"
            style={{ color: cliTheme.textMuted }}
            onClick={onAddTab}
            aria-label="New tab"
          >
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className="h-8 w-8 shrink-0 rounded-sm cursor-pointer border-0 bg-transparent hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/30"
          style={{ color: cliTheme.textMuted }}
