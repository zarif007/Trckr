...
export function CreateDropdown(props: CreateDropdownProps) {
  ...
  const availableConfigTypes = isModule
    ? (props.availableConfigTypes ?? [])
    : [];
            ...
            {hasConfigOptions && (
              <div className="relative">
                <button
                  ...
                  className="flex items-center justify-between gap-2 px-2.5 py-1.5 text-xs font-medium rounded-sm hover:bg-muted/60 transition-colors text-left w-full"
                >
                ...
                {configSubmenuOpen && (
                  <div
                    className="absolute left-0 top-full mt-0.5 min-w-[140px] py-1 rounded-sm border bg-popover z-50"
                    role="menu"
                  >
                    {availableConfigTypes.map((type) => (
                      <button
                        ...
                        className="flex items-center gap-2 px-2.5 py-1.5 text-xs font-medium rounded-sm hover:bg-muted/60 transition-colors text-left w-full disabled:opacity-50"
                        role="menuitem"
                      >
                        <FileText className="h-3.5 w-3.5 text-muted-foreground" />
