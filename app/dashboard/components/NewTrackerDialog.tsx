...
export function NewTrackerDialog({
 ...
 {trigger ?? (
 <Button size="sm" variant="ghost" className="h-7 gap-1.5 rounded-sm text-xs font-medium">
 ...
 {error ? (
 <p className="text-xs text-destructive bg-destructive/10 px-3 py-2 rounded-sm" role="alert">
 {error}
 </p>
 ) : null}
 </div>
