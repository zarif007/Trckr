...
export const suggestions = [
  {
    ...
    query:
      "Create a personal fitness tracker to log daily workouts, sets, reps, and body weight progress.",
  ...
  },
  {
    ...
    query:
      "Build a company inventory system to track stock levels, supplier contacts, and warehouse locations.",
  ...
  },
  {
    ...
    query:
      "Design a digital cookbook for saving recipes, including ingredient lists, difficulty ratings, and preparation time.",
  ...
  },
  {
    ...
    query:
      "Create a project management tracker with task deadlines, priority levels, and kanban stages.",
...
export const dataSuggestions = [
  {
    ...
    query:
      "Give me a concise summary of the key trends and insights from the data in this tracker.",
  ...
  },
  {
    ...
    query:
      "Analyze this tracker data and highlight any important trends, spikes, or anomalies I should know about.",
  ...
  },
  {
    ...
    query:
      "Based on the data in this tracker, suggest next steps, improvements, or actions I should consider.",
