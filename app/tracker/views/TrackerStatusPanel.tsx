  ...
  return (
    <div className="space-y-3">
      {validationErrors.length > 0 && (
        <div
          className="flex items-start gap-3 rounded-sm border-l-2 border-amber-500/80 bg-amber-500/5 px-4 py-3"
          role="alert"
        >
      ...
      {error && !isLoading && (
        <div className="flex items-start gap-3 rounded-sm border-l-2 border-red-500/80 bg-red-500/5 px-4 py-3">
      ...
      {showNoTracker && !error && (
        <div className="flex items-start gap-3 rounded-sm border-l-2 border-amber-500/80 bg-amber-500/5 px-4 py-3">
          <AlertTriangle className="h-4 w-4 shrink-0 text-amber-600 mt-0.5" />
          <div className="min-w-0 flex-1">
            <p className="text-sm font-semibold text-foreground">
              No tracker generated
            </p>
            <p className="text-xs text-muted-foreground mt-0.5 whitespace-pre-wrap break-words">
              {generationErrorMessage ||
                "The AI responded but did not produce a valid tracker."}
            </p>
            <Button
              variant="ghost"
              size="sm"
