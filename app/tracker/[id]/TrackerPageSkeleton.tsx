      ...
      >
        <div className="flex-1 min-h-0 flex overflow-hidden">
          ...
          >
            ...
            <div
              className={cn(
                "absolute top-3 right-3 z-20 flex max-w-[calc(100%-0.5rem)] flex-wrap items-center justify-end gap-1 rounded-sm border border-border/50 bg-background/85 p-1 backdrop-blur-md",
                theme.border.subtle,
              )}
            >
              <div
                className={cn(
                  "inline-flex shrink-0 items-center gap-1 rounded-sm border bg-background/80 p-0.5",
                  theme.border.subtle,
                )}
              >
            ...
            <div className="h-full overflow-y-auto px-2 pt-14 pb-2">
              <div className="w-full min-w-0 space-y-4 px-0 py-2 md:px-1 md:py-2 rounded-sm bg-card">
                <Tabs defaultValue="tab1" className="w-full min-w-0 gap-2">
                  <div className="flex items-center gap-2 min-w-0 overflow-x-auto">
                    <TabsList className="h-9 w-fit inline-flex">
                      <Skeleton className="h-8 w-24 rounded-sm mx-0.5" />
                      <Skeleton className="h-8 w-20 rounded-sm mx-0.5" />
                    </TabsList>
                  </div>
                  <TabsContent
                    value="tab1"
          ...
          >
            ...
            >
              ...
              >
                <div
                  className={cn(
                    "absolute top-3 right-1 z-20 flex max-w-[calc(100%-0.5rem)] items-center gap-1 rounded-sm border border-border/50 bg-background/85 p-1 backdrop-blur-md",
                    theme.border.subtle,
                  )}
                >
                ...
                <div className="w-full min-w-0 space-y-4 px-0 py-2 md:px-1 md:py-2 rounded-sm bg-card">
                  <div className="flex items-center gap-2 min-w-0">
                    <TabsList className="h-9 w-fit inline-flex">
                      <Skeleton className="h-8 w-20 rounded-sm mx-0.5" />
                      <Skeleton className="h-8 w-16 rounded-sm mx-0.5" />
                    </TabsList>
                  </div>
                  <div
                    className={cn(
