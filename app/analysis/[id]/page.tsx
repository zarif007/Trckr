...
export default function AnalysisPage() {
 ...
 {loadError}
 <div className="mt-4">
 <Button variant="outline" size="sm" className="rounded-sm" onClick={() => router.push('/dashboard')}>
 Back to dashboard
 </Button>
 </div>
 </div>
 ...
 <div className="overflow-hidden rounded-sm border border-border/80 bg-card/40 ring-1 ring-black/[0.04] dark:ring-white/[0.07] print:print:ring-0">
