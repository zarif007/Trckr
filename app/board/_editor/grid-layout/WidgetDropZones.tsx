...
export function WidgetDropZones({ widgetId, enabled }: WidgetDropZonesProps) {
  ...
  return (
    <>
      ...
      <div
        ref={setLeftRef}
        className="absolute inset-y-0 left-0 z-20 w-[20%] pointer-events-auto"
        aria-hidden="true"
      />
      ...
      <div
        ref={setRightRef}
        className="absolute inset-y-0 right-0 z-20 w-[20%] pointer-events-auto"
        aria-hidden="true"
      />
      ...
      <div
        ref={setAboveRef}
        className="absolute inset-x-0 top-0 z-20 h-[25%] pointer-events-auto"
        aria-hidden="true"
      />
      ...
      <div
        ref={setBelowRef}
        className="absolute inset-x-0 bottom-0 z-20 h-[25%] pointer-events-auto"
        aria-hidden="true"
      />
    </>
  );
