...
export function TeamSwitcher() {
 ...
 size="sm"
 className={cn(
 'h-8 max-w-[140px] min-w-0 justify-between gap-1.5 rounded-sm border px-2 font-medium text-muted-foreground hover:text-foreground',
 theme.border.subtle
 )}
 ...
 className="w-full flex items-center gap-2 rounded-sm px-2 py-2 text-sm text-left hover:bg-muted focus:bg-muted focus:outline-none"
