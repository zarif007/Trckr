...
export const LANDING_DEMO_REPORT_ROWS: Record<string, unknown>[] =
  _landingDemoReportRows;

export const LANDING_DEMO_REPORT_RECIPE_TOTAL_BUDGET =
  _landingDemoReportRows.reduce((sum, r) => {
    const v = r.sum_budget;
    return sum + (typeof v === "number" && Number.isFinite(v) ? v : 0);
  }, 0);

export const LANDING_DEMO_REPORT_FILTERED_DEAL_COUNT =
  _landingDemoReportRows.reduce((sum, r) => {
