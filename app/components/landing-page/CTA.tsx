        ...
        <div className="space-y-8 sm:space-y-10 text-center">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground/65 max-w-md mx-auto leading-relaxed">
              Built for teams who&apos;ve outgrown Notion tables and Excel
              sheets. Describe what you need — it&apos;s already built.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Button
              size="lg"
              className="h-12 px-8 text-sm font-medium rounded-sm bg-foreground text-background hover:bg-foreground/90 transition-colors"
              asChild
            >
              <a
