...
export function TrackerMessageList({
 ...
 {message.content && (
 <div
 className={`rounded-sm px-4 py-2.5 text-sm leading-relaxed ${message.role === 'user'
 ...
 <div key={i} className="flex items-start gap-2 text-xs font-medium text-foreground/90 bg-background/40 p-2 rounded-sm border border-border/20 min-w-0 w-full">
 ...
 <div key={i} className="flex items-center gap-3 text-xs font-medium text-foreground bg-background/40 p-2 rounded-sm border border-border/20 min-w-0 w-full">
