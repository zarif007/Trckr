...
export function MasterDataCreatedTrackersPanel({
  audit,
  className,
}: MasterDataCreatedTrackersPanelProps) {
        ...
        {created.map((action, i) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-muted-foreground font-mono text-[10px] mt-0.5 break-all">
                {action.trackerId}
              </p>
            </div>
          </div>
