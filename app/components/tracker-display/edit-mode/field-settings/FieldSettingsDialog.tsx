...
export function FieldSettingsDialog(props: FieldSettingsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90vh] flex-col sm:max-w-[720px] p-0 gap-0 overflow-hidden">
              ...
              <TabsList className="w-full h-8">
                ...
                {resolvedAllowedTabs.includes("validations") && (
                  <TabsTrigger value="validations" className="gap-1.5 text-xs">
                    ...
                    {rules.length > 0 && (
                      <span className="ml-1 h-4 min-w-[16px] px-1 rounded-sm text-[10px] font-medium bg-muted text-muted-foreground flex items-center justify-center">
                        {rules.length}
                      </span>
                    )}
                  </TabsTrigger>
                ...
                {resolvedAllowedTabs.includes("calculations") && (
                  <TabsTrigger value="calculations" className="gap-1.5 text-xs">
                    ...
                    {calculationRule && (
                      <span className="ml-1 h-4 min-w-[16px] px-1 rounded-sm text-[10px] font-medium bg-success/15 text-success flex items-center justify-center">
                        1
                      </span>
                    )}
                  </TabsTrigger>
                )}
                {resolvedAllowedTabs.includes("fieldRules") &&
                  gridId &&
                  field && (
                ...
                {resolvedAllowedTabs.includes("dynamicOptions") &&
                  isDynamicField && (
                    <TabsTrigger
                  ...
                  <TabsContent value="general" className="mt-0 space-y-5">
                    <GeneralTab
                      ...
                      resolveAutoPopulateFromPathLabelFn={
                        state.resolveAutoPopulateFromPathLabelFn
                      }
                  ...
                  <TabsContent value="bindings" className="mt-5 space-y-5">
                    <BindingsTab
                      ...
                      resolveBindingFromPathLabelFn={
                        state.resolveBindingFromPathLabelFn
                      }
                      ...
                      getBindingSourceGridFieldOptions={
                        state.getBindingSourceGridFieldOptions
                      }
                  ...
                  field && (
                    <TabsContent value="fieldRules" className="mt-0 space-y-5">
                      <FieldRulesV2Tab
                        ...
                        availableFields={state.availableFields}
                        currentTracker={
                          schema as import("../../types").TrackerDisplayProps
                        }
