...
export interface ValidationsTabProps {
  ...
  handleRuleTypeChange: (
    index: number,
    nextType: FieldValidationRule["type"],
  ) => void;
    ...
    <div className="space-y-2">
      {rules.map((rule, index) => {
        ...
        return (
          <div
            key={index}
            className={cn(rule.enabled === false && "opacity-50")}
          >
            <RuleCardShell
              icon={icon}
              badges={badges}
              ...
              <div className="space-y-3 pt-1">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleRuleTypeChange(
                          index,
                          value as FieldValidationRule["type"],
                        )
                      }
                    >
                      <SelectTrigger
                      ...
                      <SelectContent>
                        <SelectGroup>
                          ...
                          <SelectItem value="required">
                            {RULE_TYPE_LABELS.required}
                          </SelectItem>
                          <SelectItem value="min">
                            {RULE_TYPE_LABELS.min}
                          </SelectItem>
                          <SelectItem value="max">
                            {RULE_TYPE_LABELS.max}
                          </SelectItem>
                          <SelectItem value="minLength">
                            {RULE_TYPE_LABELS.minLength}
                          </SelectItem>
                          <SelectItem value="maxLength">
                            {RULE_TYPE_LABELS.maxLength}
                          </SelectItem>
                        </SelectGroup>
                        <SelectGroup>
                          <SelectLabel className="text-muted-foreground font-medium text-xs uppercase tracking-wider">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    value={rule.message ?? ""}
                    onChange={(e) =>
                      updateRule(index, { ...rule, message: e.target.value })
                    }
