        ...
        <CardContent>
          ...
          <div className="mt-4 max-w-xs space-y-2">
            ...
            <p className="text-[11px] text-muted-foreground">
              Shown before the value in inputs and display (e.g. currency
              symbol).
            </p>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <FieldWrapper className="max-w-xs">
              <Select
                value={dataType}
                onValueChange={(v) => setDataType(v as TrackerFieldType)}
              >
                <SelectTrigger
            ...
            <div className="space-y-2 max-w-xs">
              ...
              <FieldWrapper>
                <Select
                  value={dateFormat}
                  onValueChange={(v) =>
                    setDateFormat(v as "iso" | "us" | "eu" | "long")
                  }
                >
                  <SelectTrigger
                    id="field-settings-date-format"
                    className={FIELD_FORM_INPUT_CLASS}
                  >
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div className="space-y-1.5 self-end pb-1">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <label
                    htmlFor="field-settings-rating-half"
                    className="text-sm font-medium cursor-pointer"
                  >
                    Allow half steps
                  </label>
          ...
          {dataType === "person" && (
            <div className="space-y-1.5">
              <div className="flex items-center gap-3">
                ...
                />
                <label
                  htmlFor="field-settings-person-multi"
                  className="text-sm font-medium cursor-pointer"
                >
