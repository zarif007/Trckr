    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Choose a tracker, then any grid, then the field that provides labels
          and stored values for master data.
        </p>
        ...
        {(bindingValidation.errors.optionsGrid ||
          ...
          <div className="text-xs text-destructive space-y-0.5">
            {bindingValidation.errors.optionsGrid && (
              <div>{bindingValidation.errors.optionsGrid}</div>
            )}
            {bindingValidation.errors.labelField && (
              <div>{bindingValidation.errors.labelField}</div>
            )}
          </div>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Mappings control auto‑population. When a user selects an option,
          values from the master data fields (left) are copied into target
          fields on this grid (right).
        </p>
        <FieldMappingsEditor
