  ...
  const content = (
    <>
      <button
        type="button"
        className={cn(
          "flex items-center justify-center shrink-0 rounded-sm hover:bg-muted text-muted-foreground/50 hover:text-foreground transition-colors",
      ...
      <button
        type="button"
        className={cn(
          "flex items-center justify-center shrink-0 rounded-sm hover:bg-destructive/10 text-muted-foreground/50 hover:text-destructive transition-colors",
          inline ? "h-6 w-6 p-0" : "h-6 w-6",
        )}
        onClick={(e) => {
          e.stopPropagation();
