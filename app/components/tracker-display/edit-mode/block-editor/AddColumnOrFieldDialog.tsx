        ...
        <div className="relative border-b border-border/50 px-6 pt-6 pb-5 bg-background">
          <DialogHeader className="space-y-1.5">
            ...
            <DialogDescription className="text-muted-foreground text-sm leading-relaxed">
              Choose an existing {labelName.toLowerCase()} or define a new one
              in a single flow.
            </DialogDescription>
          </DialogHeader>
        </div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <FieldWrapper>
                ...
                >
                  ...
                  >
                    <SelectValue
                      placeholder={`Select a ${labelName.toLowerCase()}...`}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    {availableFields.length === 0 ? (
                      <div className="mx-1 my-2 rounded-sm border border-dashed border-border/60 bg-muted/30 py-6 text-center text-sm text-muted-foreground">
            ...
            <div className={cn("space-y-5", existingFieldId && "opacity-55")}>
              <div className="space-y-2">
                ...
                <FieldWrapper
                  error={labelInvalid}
                  errorTitle={labelError ?? undefined}
                >
                  <Input
                    id="new-label"
                    value={newLabel}
                    ...
                    placeholder={
                      variant === "column" ? "e.g. Status" : "e.g. Description"
                    }
                    className={FIELD_FORM_INPUT_CLASS}
                    aria-invalid={labelInvalid}
                    aria-describedby={
                      labelError ? "new-label-error" : undefined
                    }
                  />
                </FieldWrapper>
                {labelError && (
