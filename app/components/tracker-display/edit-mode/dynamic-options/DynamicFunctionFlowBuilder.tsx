...
const NODE_BASE_CLASSES = 'overflow-hidden rounded-sm border border-border/50 bg-background transition-all duration-200 hover:hover:-translate-y-px'
...
function DynamicNodeCardInlineConfig({
 ...
 return (
 <div key={key} className="flex flex-wrap items-center gap-1 rounded-sm border border-border/60 bg-muted/20 p-1.5">
 <Input
 value={key}
 onChange={(e) => {
