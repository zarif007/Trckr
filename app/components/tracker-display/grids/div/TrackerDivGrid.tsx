...
function TrackerDivGridInner({
 ...
 return map
 }, [optionFieldIds, bindingByFieldId, trackerContext?.grids, trackerContext?.foreignSchemaBySchemaId])
 ...
 [compiledCalculationPlan, calculatedFieldIds, data, draftRow, fullGridData, onUpdate]
 )
