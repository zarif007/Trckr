          ...
          <span className="flex min-w-0 items-center gap-2">
            ...
            <span className="min-w-0">
              ...
              <span className="block text-[11px] text-muted-foreground">
                Map master data columns to this grid
              </span>
            </span>
          </span>
      ...
      >
        <DialogHeader className="shrink-0 space-y-1.5 border-b border-border/60 px-5 pt-5 pb-4 text-left">
          ...
          <DialogDescription className="text-xs leading-relaxed">
            When someone picks an option in the bound select, values copy from
            the master data row (left) into fields on this grid (right). Use{" "}
            <span className="font-medium text-foreground/90">Auto-map</span> on
            the bindings tab for suggested pairs.
          </DialogDescription>
        </DialogHeader>
          ...
          {mappings.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-2 rounded-sm border border-dashed border-border/70 bg-muted/20 py-12 px-4 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                No mappings yet. Add rows below or run Auto-map to match fields
                by name.
              </p>
            </div>
          ) : (
