...
export function EntryWayButton({
 ...
 return (
 <div className="inline-flex items-stretch rounded-sm border border-border/70 bg-card/80 text-xs overflow-hidden">
 <AddEntryButton
 ...
 <PopoverContent align="end" className="w-56 rounded-sm border-border/60 p-1.5 text-xs">
 {entryWays.length === 0 ? (
