...
const buttonVariants = cva(
 ...
 outline: theme.patterns.outlineButton,
 secondary:
 ...
 icon: "size-9 aspect-square p-0 flex-none",
 "icon-sm": "size-8 aspect-square p-0 flex-none",
 "icon-lg": "size-10 aspect-square p-0 flex-none",
 },
 },
 defaultVariants: {
 variant: "default",
