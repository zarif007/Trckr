...
-- CreateIndex
CREATE INDEX "Board_moduleId_idx" ON "Board"("moduleId");
...
-- AddForeignKey
ALTER TABLE "Board" ADD CONSTRAINT "Board_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE SET NULL ON UPDATE CASCADE;
